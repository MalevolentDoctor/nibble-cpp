...
RLAPI void rlSetCullDistanceNear(double dist);          // Set frustrum near distance culling
RLAPI void rlSetCullDistanceFar(double dist);           // Set frustrum far distance culling
...
static double cullDistanceNear = RL_DEFAULT_CULL_DISTANCE_NEAR;
static double cullDistanceFar = RL_DEFAULT_CULL_DISTANCE_FAR;
...
// Set near cull distance
void rlSetCullDistanceNear(double dist) { cullDistanceNear = dist; }

// Set far cull distance
void rlSetCullDistanceFar(double dist) { cullDistanceFar = dist;  }
