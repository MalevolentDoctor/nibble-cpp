...
Matrix GetCameraProjectionMatrix(Camera *camera, float aspect)
{
    ...
    {
        return MatrixPerspective(camera->fovy*DEG2RAD, aspect, cullDistanceNear, cullDistanceFar);
    }
    else if (camera->projection == CAMERA_ORTHOGRAPHIC)
    {
        ...
        return MatrixOrtho(-right, right, -top, top, cullDistanceNear, cullDistanceFar);
    }
